...
#ifndef PURPLE_HELPER_VALIDATOR_HPP
#define PURPLE_HELPER_VALIDATOR_HPP
...
private:
  static bool regex_match(const std::string &s, const std::regex &r);

public:
  static bool has_length(const std::string &str, size_t min_len,
                         size_t max_len);

  static bool is_valid_password(const std::string &password);
  static bool is_valid_password(PasswordStrengthFlags flags,
